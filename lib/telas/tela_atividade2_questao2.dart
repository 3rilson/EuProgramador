...
class TelaAtividade2Questao2 extends StatefulWidget {
  @override
  _TelaAtividade2Questao2State createState() => _TelaAtividade2Questao2State();
}

class _TelaAtividade2Questao2State extends State<TelaAtividade2Questao2> {


  List selecionado = [];
  List respostaCerta = ["if", "else", "if", "else"];
  List respostas = ["pizza", "if", "else", "o", "táxi", "favor", "seu"];
  List<bool> cardCinzaAux = [true, true, true, true];
          ...
          Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  "2) Complete o código corretamente de acordo com o estudado neste capítulo.",
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text("(valor > 100){", style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),),
                        ...
                        Row(
                          children: <Widget>[
                            Text("      printf(\" número alto \");", style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),),
                          ],
                        ),
                        ...
                        Row(
                          children: <Widget>[
                            cardCinzas[1],
                            cardCinzas[2],
                            Text("(valor >= 50 && <= 70){", style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),),
                        ...
                        Row(
                          children: <Widget>[
                            Text("      printf(\" número médio \");", style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),),
                          ],
                        ),
                        ...
                        Row(
                          children: <Widget>[
                            Text("      printf(\" número baixo \");", style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),),
                          ],
                        ),
